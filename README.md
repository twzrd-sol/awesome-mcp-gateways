...
- **[TWZRD Agent Intel](https://intel.twzrd.xyz)** - Production x402 payment gateway as MCP — agents call `https://intel.twzrd.xyz/mcp`, server validates Solana USDC micropayments (<1s) and returns signed V5 trust receipts.
